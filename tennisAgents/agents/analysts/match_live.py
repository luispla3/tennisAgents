...
def create_match_live_analyst(llm, toolkit):
    def match_live_analyst_node(state):
        ...
        additional_context = (
            ...
            "## 4. ANÁLISIS DEL MOMENTUM\n"
            "   Basándote en las estadísticas y el marcador, analiza:\n"
            "   - ¿Quién está dominando el partido y por qué?\n"
            "   - ¿Qué jugador tiene ventaja en servicio?\n"
            "   - ¿Quién está siendo más agresivo en break points?\n"
            "   - ¿Hay indicadores de cambio de momentum?\n"
            "   - Factores clave que están determinando el resultado\n\n"
