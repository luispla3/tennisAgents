...
def create_player_analyst(llm, toolkit):
    def player_analyst_node(state):
        ...
        additional_context = (
            ...
            "debes proporcionar una predicción CONCRETA y JUSTIFICADA del resultado del primer set:\n\n"
            "### SÍNTESIS DE FACTORES CLAVE:\n"
            "### ESCENARIOS PROBABLES PARA EL PRIMER SET:\n"
            ...
            "### PREDICCIÓN FINAL DEL PRIMER SET:\n"
            ...
            "• {player_name} gana el primer set: [XX]%\n"
            "• {opponent_name} gana el primer set: [XX]%\n\n"
            "**RECUERDA: En tu reporte, incluye el encabezado '## FUNDAMENTAL 3: PREDICCIÓN DEL RESULTADO DEL PRIMER SET' antes de esta sección.**\n\n"
