...
def create_player_analyst(llm, toolkit):
    def player_analyst_node(state):
        ...
        system_message = (
            ...
            "PASO 1: get_injury_reports() - SOLO UNA VEZ \n"
            "PASO 2: get_atp_rankings() - SOLO UNA VEZ\n"
            "PASO 3: Extraer IDs del ranking para {player_name} y {opponent_name}\n"
            "PASO 4: get_recent_matches(ID_jugador1, ID_jugador2) - SOLO UNA VEZ\n"
            "PASO 5: get_surface_winrate(ID_jugador1, '{surface}') - SOLO UNA VEZ\n"
            "PASO 6: get_surface_winrate(ID_jugador2, '{surface}') - SOLO UNA VEZ\n"
            "PASO 7: get_head_to_head(ID_jugador1, ID_jugador2) - SOLO UNA VEZ\n"
            "PASO 8: Analizar y crear informe\n\n"
            "REGLAS ESTRICTAS:\n"
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    "1. get_injury_reports() - UNA SOLA VEZ (puedes llamarlo cuando quieras)\n"
                    "2. get_atp_rankings() - UNA SOLA VEZ\n"
                    "3. get_recent_matches(ID_jugador1, ID_jugador2) - UNA SOLA VEZ\n"
                    "4. get_surface_winrate(ID_jugador1, '{surface}') - UNA SOLA VEZ\n"
                    "5. get_surface_winrate(ID_jugador2, '{surface}') - UNA SOLA VEZ\n"
                    "6. get_head_to_head(ID_jugador1, ID_jugador2) - UNA SOLA VEZ\n"
                    "7. Analizar y crear informe\n\n"
