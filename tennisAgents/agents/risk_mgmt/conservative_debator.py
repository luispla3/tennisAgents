...
"""
        ...
        anatomy = RiskManagerAnatomies.conservative_debator()
        ...
        # Invocar al LLM
        response = llm.invoke(prompt.invoke({"user_message": "Genera tu análisis conservador y estrategia de inversión segura basada en la información proporcionada."}))
